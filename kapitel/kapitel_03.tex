...
Der Vorteil gegenüber einem \textit{\nameref{sec:git-commands.advanced.merge}} ist, dass wenn der Entwickler die Historie auflösen möchte, nicht alle Verzweigungen bzw Branches mit auflösen muss. Ein Rebase hält die Historie möglichst sauber.
...
\label{sec:git-commands.advanced.status}
